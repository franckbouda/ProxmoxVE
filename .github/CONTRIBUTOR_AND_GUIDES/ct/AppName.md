...
```bash
source <(curl -fsSL https://raw.githubusercontent.com/franckbouda/ProxmoxVE/main/misc/build.func)
```

> [!CAUTION]
> Before opening a Pull Request, change the URLs to point to the franckbouda repo.
