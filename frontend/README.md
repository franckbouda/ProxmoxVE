...
> 🚀 **Modern frontend for the franckbouda Proxmox VE Helper-Scripts repository**

A comprehensive, user-friendly interface built with Next.js that provides access to 300+ automation scripts for Proxmox Virtual Environment management. This frontend serves as the official website for the franckbouda organization's Proxmox VE Helper-Scripts repository.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/franckbouda/ProxmoxVE.git
...
- **[franckbouda Organization](https://github.com/franckbouda)** - Maintaining and expanding the project
...
- **[Community Scripts Repository](https://github.com/franckbouda/ProxmoxVE)**
- **[Discord Community](https://discord.gg/2wvnMDgdnU)**
- **[GitHub Discussions](https://github.com/franckbouda/ProxmoxVE/discussions)**

## 🔗 Links

- **🌐 Live Website**: [https://franckbouda.github.io/ProxmoxVE/](https://franckbouda.github.io/ProxmoxVE/)
- **💬 Discord Server**: [https://discord.gg/2wvnMDgdnU](https://discord.gg/2wvnMDgdnU)
- **📝 Change Log**: [https://github.com/franckbouda/ProxmoxVE/blob/main/CHANGELOG.md](https://github.com/franckbouda/ProxmoxVE/blob/main/CHANGELOG.md)

---

**Made with ❤️ by the franckbouda team and contributors**
