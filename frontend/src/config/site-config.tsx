...
export const navbarLinks = [
  {
    href: `https://github.com/franckbouda/${basePath}`,
    event: "GitHub",
  ...
  {
    href: `https://github.com/franckbouda/${basePath}/blob/main/CHANGELOG.md`,
    event: "Changelog",
  ...
  {
    href: `https://github.com/franckbouda/${basePath}/discussions`,
    event: "Discussions",
