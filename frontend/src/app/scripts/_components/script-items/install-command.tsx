...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/franckbouda/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.franckbouda.org/franckbouda/${basePath}/raw/branch/main/${scriptPath}`;
